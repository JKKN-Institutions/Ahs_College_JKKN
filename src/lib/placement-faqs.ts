/**
 * The /placements FAQ. ONE array: the accordion on the page renders it and the FAQPage schema
 * in placements/layout.tsx is built from it. They were separate arrays and four answers had
 * drifted, so the schema declared answers the page never showed.
 */
export const PLACEMENT_FAQS = [
    ...
    },
    {
        ...
        answer: "JKKN publishes no audited average salary, so no figure is stated here. Salaries vary by specialization — Cardiac Technology and Radiology graduates typically earn higher starting packages — and roles abroad generally pay more. The placement cell can give current, verifiable figures on request."
    },
    {
        question: "Which hospitals recruit from JKKN AHS?",
        answer: "Recruiters include Apollo Hospitals, MIOT International, Fortis Healthcare, Manipal Hospitals, Kauvery Hospital, Columbia Asia, Narayana Health, GEM Hospital, SRL Diagnostics, Thyrocare, and Dr. Lal PathLabs. International recruiters include NHS UK and hospitals in UAE, Saudi Arabia, and Singapore."
    },
    {
    ...
    },
    {
        ...
        answer: "JKKN AHS runs a dedicated placement cell with year-round operations, clinical tie-ups with tier-1 hospitals including Apollo, MIOT and Fortis, and support for graduates seeking roles abroad. No recruiter count or rival comparison is published here, because neither figure is audited."
    }
];
