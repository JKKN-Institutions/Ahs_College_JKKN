        ...
        <div className="min-h-screen flex flex-col bg-[#fbfbee]">
            ...
            <section className="bg-gradient-to-br from-[#0b6d41] to-[#12a15f] py-16">
                <div className="max-w-3xl mx-auto px-4">
                    ...
                    <AhsEnquiryForm sourcePage="dialysis-technology" defaultProgrammeId={DEFAULT_PROGRAMME_BY_PAGE["dialysis-technology"]} />
                </div>
            </section>
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10 flex flex-col md:flex-row gap-12 items-center">
                ...
                <div className="md:w-1/2 w-full">
                    <div className="relative rounded-3xl overflow-hidden aspect-video shadow-2xl border-4 border-white group">
                        <Image
                            src="/dialysis-technology-hero.webp"
            ...
            <div className="max-w-7xl mx-auto px-4 flex flex-col lg:flex-row gap-16">
                <div className="lg:w-2/3">
                    ...
                    <div className="text-gray-600 leading-relaxed text-lg space-y-6 text-justify">
                        ...
                        <p>
                            The learning framework covers renal anatomy and physiology, principles of hemodialysis and peritoneal dialysis, dialysis machine operations, water treatment systems, vascular access management, patient assessment, infection control, and emergency management in dialysis settings.
                        </p>
                        <p>
        ...
        <section id="academic-curriculum" className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-12">
                    ...
                    <p className="text-gray-500 mt-2">Comprehensive learning framework with strong foundation in renal sciences and extensive practical training</p>
                </div>
        ...
        <section className="bg-[#fbfbee] py-24 text-[#0b6d41]">
            ...
            <div className="max-w-4xl mx-auto px-4 mt-14 text-center">
              <p className="text-gray-900">
                ...
                <Link
                  href="/course-blog/future-of-dialysis-technology-careers"
                  className="font-bold text-[#0b6d41] underline underline-offset-4 hover:text-[#12a15f] transition-colors"
                >
                  Read our B.Sc Dialysis Technology career guide
                </Link>
                .
              </p>
            </div>
