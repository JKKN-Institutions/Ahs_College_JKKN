...
export const metadata = createPageMetadata({
  ...
  description:
    "Hygienic food court at JKKN campus offering nutritious vegetarian and non-vegetarian meals for learners and team members at affordable prices.",
  path: "/food-court",
  keywords: [
    ...
    "learner canteen Namakkal college",
...
const facilitySchema = {
  ...
  "description": "Hygienic food court at JKKN campus offering nutritious vegetarian and non-vegetarian meals for learners and team members at affordable prices.",
  "url": "https://ahs.jkkn.ac.in/food-court",
  "containedInPlace": {
...
const faqSchema = {
  ...
  "mainEntity": [
    ...
    { "@type": "Question", "name": "Are meals included in the hostel fee at JKKN?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, hostel learners receive three nutritious meals daily through the campus mess as part of their hostel accommodation package." } },
