...
export const metadata = createPageMetadata({
  ...
  ogImage: {
    ...
    width: 1200,
    height: 630,
    alt: "JKKN College of Allied Health Sciences — Best AHS College Near Coimbatore",
  },
});
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Coimbatore has 14+ allied health science colleges. JKKN College of Allied Health Sciences, located ~105 km from Coimbatore on NH-544, offers a strong value proposition with competitive fees, 9 BSc programmes, NAAC approval, and an 85%+ placement rate with international opportunities.",
      },
    },
    {
      "@type": "Question",
...
const courseListSchema = {
  ...
  description: "9 BSc Allied Health Science programmes offered at JKKN College of Allied Health Sciences, accessible from Coimbatore",
  numberOfItems: 9,
  itemListElement: [
...
const howToSchema = {
  ...
  description: "Step-by-step admission process for BSc Allied Health Sciences at JKKN College of Allied Health Sciences, near Coimbatore.",
  totalTime: "P14D",
  step: [
...
const speakableSchema = {
  "@context": "https://schema.org",
  "@type": "WebPage",
  name: "Allied Health Sciences Colleges in Coimbatore | JKKN AHS",
  url: "https://ahs.jkkn.ac.in/coimbatore",
  speakable: {
