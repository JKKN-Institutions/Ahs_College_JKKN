    ...
    <section className="bg-gradient-to-br from-[#006837] via-[#006837] to-[#002309] text-white py-16 md:py-24 relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        <p className="text-white/85 text-base sm:text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          85%+ placement support — just 30-40 km from Erode with excellent
...
function TestimonialsSection() {
  const testimonials = [
    {
      quote:
        "[Student testimonial from Erode to be added here. Include their experience at JKKN AHS, what they liked about the campus, and their career outcomes.]",
      name: "[Student Name]",
      detail: "[Course], Batch of [Year] • Now at [Company]",
    },
    {
      quote:
        "[Second student testimonial from Erode to be added here. Focus on the ease of commute/hostel life and the quality of education.]",
      name: "[Student Name]",
  ...
  return (
    <section className="bg-[#FBFBEE] py-14 px-4">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="text-2xl sm:text-3xl font-black text-gray-900 mb-3">
          Students from Erode Love JKKN AHS
        </h2>
        <p className="text-gray-500 text-sm mb-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="border-2 border-dashed border-orange-300 bg-orange-50 rounded-2xl p-6 flex items-center justify-center text-center">
            <p className="text-[#7cb983] text-sm font-medium leading-relaxed">
              Add 2-3 real student testimonials from Erode or nearby areas before deployment.
            </p>
          </div>
        </div>
      </div>
