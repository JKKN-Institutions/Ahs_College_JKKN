        ...
        <div className="min-h-screen flex flex-col bg-[#fbfbee]">
            ...
            <section className="bg-gradient-to-br from-[#0b6d41] to-[#12a15f] py-16">
                <div className="max-w-3xl mx-auto px-4">
                    ...
                    <AhsEnquiryForm sourcePage="accident-emergency-care" defaultProgrammeId={DEFAULT_PROGRAMME_BY_PAGE["accident-emergency-care"]} />
                </div>
            </section>
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10 flex flex-col md:flex-row gap-12 items-center">
                ...
                <div className="md:w-1/2 w-full">
                    <div className="relative rounded-3xl overflow-hidden aspect-video shadow-2xl border-4 border-white group">
                        <Image
                            src="/accident-emergency-care-hero.webp"
        ...
        <section className="py-24 max-w-7xl mx-auto px-4 py-4 flex flex-col lg:flex-row gap-16">
            <div className="lg:w-2/3">
                ...
                <div className="text-gray-600 leading-relaxed text-lg space-y-6 text-justify">
                    ...
                    <p>
                        The learning framework covers emergency medicine fundamentals, trauma assessment and management, advanced cardiac life support (ACLS), advanced trauma life support (ATLS), disaster management, pre-hospital care, emergency pharmacology, airway management, shock management, and emergency medical procedures. Learners gain expertise in rapid patient assessment, triage, life-saving interventions, and emergency response coordination.
                    </p>
                    <p>
    ...
    return (
        <section id="academic-curriculum" className="py-24 max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
                ...
                <p className="text-gray-500 mt-2">Comprehensive learning framework with strong foundation in emergency medicine and extensive practical training</p>
            </div>
        ...
        <section className="bg-[#fbfbee] py-24 text-[#0b6d41]">
            ...
            <div className="max-w-4xl mx-auto px-4 mt-14 text-center">
              <p className="text-gray-900">
                ...
                <Link
                  href="/course-blog/accident-emergency-care-technician-guide"
                  className="font-bold text-[#0b6d41] underline underline-offset-4 hover:text-[#12a15f] transition-colors"
                >
                  Read our B.Sc Accident & Emergency Care Technology career guide
                </Link>
                .
              </p>
            </div>
...
function FAQSection() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            a: "Yes, emergency care requires physical stamina, quick thinking, and emotional resilience. The program includes physical fitness training and prepares learners to handle high-stress situations, long shifts, and physically demanding tasks. However, the rewarding nature of saving lives makes it a fulfilling career choice."
        },
    ];
