        ...
        <div className="min-h-screen flex flex-col bg-[#fbfbee]">
                ...
                <section className="py-12 px-4 md:px-8 lg:px-16 bg-[#f0f7f2]">
                  <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
                      <Link href="/erode" className="px-4 py-3 bg-white rounded-xl border border-gray-100 text-sm font-medium text-gray-700 hover:border-[#0b6d41] hover:text-[#0b6d41] transition-colors text-center">Erode (~22 km)</Link>
                ...
                <section className="py-12 px-4 md:px-8 lg:px-16 bg-white/50">
                  <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                      ...
                      <Link href="/wifi" className="px-4 py-3 bg-white rounded-xl border border-gray-100 text-sm font-medium text-gray-700 hover:border-[#0b6d41] hover:text-[#0b6d41] transition-colors text-center">WiFi Campus</Link>
                      <Link href="/ambulance-service" className="px-4 py-3 bg-white rounded-xl border border-gray-100 text-sm font-medium text-gray-700 hover:border-[#0b6d41] hover:text-[#0b6d41] transition-colors text-center">Ambulance</Link>
                    </div>
                  </div>
                </section>
            </main>
            ...
            <section className="bg-gradient-to-br from-[#0b6d41] to-[#12a15f] py-16">
                <div className="max-w-3xl mx-auto px-4">
                    ...
                    <AhsEnquiryForm sourcePage="cardiac-technology" defaultProgrammeId={DEFAULT_PROGRAMME_BY_PAGE["cardiac-technology"]} />
                </div>
            </section>
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10 flex flex-col md:flex-row gap-12 items-center">
                ...
                <div className="md:w-1/2 w-full">
                    <div className="relative rounded-3xl overflow-hidden aspect-video shadow-2xl border-4 border-white group">
                        <Image
                            src="/cardiac-technology-hero.webp"
                    ...
                    <div className="bg-white border border-gray-200 rounded-3xl p-8 sticky top-24 shadow-xl relative overflow-hidden">
                        ...
                        <ul className="space-y-4 text-sm">
                            {[
                                ...
                                { label: "Sanctioned Intake", value: "7 Seats" },
        ...
        <section className="bg-[#fbfbee] py-24 text-[#0b6d41]">
            ...
            <div className="max-w-4xl mx-auto px-4 mt-14 text-center">
              <p className="text-gray-900">
                ...
                <Link
                  href="/course-blog/scope-of-cardiac-technology-in-india"
                  className="font-bold text-[#0b6d41] underline underline-offset-4 hover:text-[#12a15f] transition-colors"
                >
                  Read our B.Sc Cardiac Technology career guide
                </Link>
                .
              </p>
            </div>
...
function FAQSection() {
    ...
    const faqs = COURSE_FAQS["cardiac-technology"];
