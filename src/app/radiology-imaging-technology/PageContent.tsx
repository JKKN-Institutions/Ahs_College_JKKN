        ...
        <div className="min-h-screen flex flex-col bg-[#fbfbee]">
            ...
            <section className="bg-gradient-to-br from-[#0b6d41] to-[#12a15f] py-16">
                <div className="max-w-3xl mx-auto px-4">
                    ...
                    <AhsEnquiryForm sourcePage="radiology-imaging-technology" defaultProgrammeId={DEFAULT_PROGRAMME_BY_PAGE["radiology-imaging-technology"]} />
                </div>
            </section>
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10 flex flex-col md:flex-row gap-12 items-center">
                <div className="md:w-1/2">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black mb-6 leading-tight">
                        B.Sc <span className="text-[#0b6d41]">Radiography Imaging Technology</span>
                    </h1>
                ...
                <div className="md:w-1/2 w-full">
                    <div className="relative rounded-3xl overflow-hidden aspect-video shadow-2xl border-4 border-white group">
                        <Image
                            src="/radiology-technology-hero.webp"
        ...
        <section className="py-24 max-w-7xl mx-auto px-4 flex flex-col lg:flex-row gap-16">
            <div className="lg:w-2/3">
                ...
                <div className="text-gray-600 leading-relaxed text-lg space-y-6 text-justify">
                    ...
                    <p>
                        The learning framework covers radiographic anatomy, radiation physics, X-ray techniques, CT scan technology, MRI imaging, ultrasound procedures, mammography, fluoroscopy, interventional radiology, radiation safety, and quality assurance. Learners gain expertise in operating sophisticated imaging equipment, patient positioning, image processing, and maintaining radiation safety standards.
                    </p>
                    <p>
                ...
                <div className="grid md:grid-cols-2 gap-6 mt-10">
                    {[
                        ...
                        { title: "Expert Senior Learners", icon: <Stethoscope />, desc: "Learn from radiologists" },
                    ].map((item, i) => (
    ...
    return (
        <section id="academic-curriculum" className="py-24 max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
                ...
                <p className="text-gray-500 mt-2">Comprehensive learning framework with strong foundation in radiological sciences and extensive practical training</p>
            </div>
        ...
        <section className="bg-[#fbfbee] py-24 text-[#0b6d41]">
            ...
            <div className="max-w-4xl mx-auto px-4 mt-14 text-center">
              <p className="text-gray-900">
                ...
                <Link
                  href="/course-blog/radiology-imaging-technology-career-guide"
                  className="font-bold text-[#0b6d41] underline underline-offset-4 hover:text-[#12a15f] transition-colors"
                >
                  Read our B.Sc Radiology & Imaging Technology career guide
                </Link>
                .
              </p>
            </div>
...
function FAQSection() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            a: "Candidates must have passed 10+2 with Physics, Chemistry, and Biology/Mathematics with minimum 50% aggregate marks (40% for SC/ST, 45% for OBC). Minimum age is 17 years as on December 31st of the admission year. A medical fitness certificate is also required."
        },
        {
