        ...
        <div className="min-h-screen flex flex-col bg-[#fbfbee]">
            ...
            <main className="flex-grow pt-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-2">
                    <Breadcrumb items={[
                        ...
                        { label: 'OT & Anaesthesia Technology' }
                    ]} />
                </div>
                <HeroSection />
                <StatsSection />
            ...
            <section className="bg-gradient-to-br from-[#0b6d41] to-[#12a15f] py-16">
                <div className="max-w-3xl mx-auto px-4">
                    ...
                    <AhsEnquiryForm sourcePage="operation-theatre-anaesthesia" defaultProgrammeId={DEFAULT_PROGRAMME_BY_PAGE["operation-theatre-anaesthesia"]} />
                </div>
            </section>
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10 flex flex-col md:flex-row gap-12 items-center">
                <div className="md:w-1/2">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black mb-6 leading-tight">
                        B.Sc <span className="text-[#0b6d41]">Operation Theatre & Anaesthesia Technology</span>
                    </h1>
            ...
            <div className="lg:w-2/3">
                ...
                <div className="grid md:grid-cols-2 gap-6 mt-10">
                    {[
                        ...
                        { title: "Expert Senior Learners", icon: <Stethoscope />, desc: "Learn from surgeons & anaesthesiologists" },
                    ].map((item, i) => (
    ...
    return (
        <section id="academic-curriculum" className="py-24 max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
                ...
                <p className="text-gray-500 mt-2">Comprehensive learning framework with strong foundation in surgical and anaesthesia sciences with extensive clinical training</p>
            </div>
