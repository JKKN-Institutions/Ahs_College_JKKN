        ...
        <div className="min-h-screen flex flex-col bg-[#fbfbee]">
            ...
            <section className="bg-gradient-to-br from-[#0b6d41] to-[#12a15f] py-16">
                <div className="max-w-3xl mx-auto px-4">
                    ...
                    <AhsEnquiryForm sourcePage="medical-record-science" defaultProgrammeId={DEFAULT_PROGRAMME_BY_PAGE["medical-record-science"]} />
                </div>
            </section>
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10 flex flex-col md:flex-row gap-12 items-center">
                ...
                <div className="md:w-1/2 w-full">
                    <div className="relative rounded-3xl overflow-hidden aspect-video shadow-2xl border-4 border-white group">
                        <Image
                            src="/medical-record-science-hero.webp"
    ...
    return (
        <section id="academic-curriculum" className="py-24 max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
                ...
                <p className="text-gray-500 mt-2">Comprehensive learning framework with strong foundation in health information management and extensive practical training</p>
            </div>
        ...
        <section className="bg-[#fbfbee] py-24 text-[#0b6d41]">
            ...
            <div className="max-w-4xl mx-auto px-4 mt-14 text-center">
              <p className="text-gray-900">
                ...
                <Link
                  href="/course-blog/medical-record-science-career-india"
                  className="font-bold text-[#0b6d41] underline underline-offset-4 hover:text-[#12a15f] transition-colors"
                >
                  Read our B.Sc Medical Record Science career guide
                </Link>
                .
              </p>
            </div>
