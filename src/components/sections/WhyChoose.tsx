...
const reasons = [
    ...
    },
    {
        ...
        description: "A dedicated placement cell helps learners apply to hospitals and diagnostic centres. No recruiter list or salary range is published here, because none is audited.",
